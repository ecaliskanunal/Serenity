...
public class SpartanEditorPostTest extends SpartanNewBase {
    ...
    // I need to give the name of my csv file and skip the first line as it shows the names of columns
    // Depending on the order in the parameter, it will assign them here from the csv file
    public void postSpartanWithCSV(String name, String gender, long phone) {
        ...
        //I take the data from csv file and put them into my map
